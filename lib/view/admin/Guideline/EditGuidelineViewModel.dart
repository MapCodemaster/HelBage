...
class EditGuidelineViewModel extends BaseViewModel {
  ...
  Future<bool> update(String title, String tag, String content, _formkey,
      guidelineModel originalGuideline) async {
  ...
  void toSingleView() {
    _navigationService
        .navigateToView(SingleGuidelineView(guideline: workingGuideline!));
  }
